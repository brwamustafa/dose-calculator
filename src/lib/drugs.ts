export interface Formulation {
    id: string;
    label: string;
    type: "tablet" | "suspension" | "capsule" | "drops" | "spray" | "infusion";
...
export const drugs: Record<string, Drug> = {
    ...
    "amoxicillin-clavulanate": {
        ...
        formulations: [
            ...
            },
            {
                ...
                strengthMgPer5ml: 400,
                unitVolumeMl: 5,
                pediatricMgPerKgPerDay: 45, // Sometimes dosed higher 90mg/kg for resistant AOM, but we keep core setting unchanged
                adultFixedDose: null,
                frequencyPerDay: 2,
                maxMgPerDay: 1750,
                minAgeMonths: 2,
    ...
    loratadine: {
        ...
        drugClass: "Antihistamine",
        route: "PO",
        pediatricMgPerKgPerDay: 0.2, // Rough placeholder, usually dosed by age/weight band (5mg for <30kg, 10mg for >30kg)
        adultDose: "10 mg",
        frequencyPerDay: 1,
        maxMgPerDay: 10,
        importantNotes: [
    ...
    fexofenadine: {
        ...
        drugClass: "Antihistamine",
        route: "PO",
        pediatricMgPerKgPerDay: 4, // Rough placeholder, usually dosed 30mg BID for 2-11yr
        adultDose: "180 mg",
        frequencyPerDay: 1,
        maxMgPerDay: 180,
        importantNotes: [
        ...
        formulations: [
            {
                ...
                strengthMgPer5ml: 30,
                unitVolumeMl: 5,
                pediatricMgPerKgPerDay: 4, // 2 times a day usually, but adult is 1. Let's adhere to 2x daily for suspension
                adultFixedDose: null,
                frequencyPerDay: 2,
                maxMgPerDay: 60,
                minAgeMonths: 6,
        ...
        formulations: [
            {
                ...
                maxMgPerDay: null,
                minAgeMonths: 72,
                notes: ["Maximum 2 doses in any 24-hour period", "Not recommended for children under 6 years without medical advice"],
            }
        ]
    },
    ciprofloxacin: {
        ...
        formulations: [
            {
                ...
                maxMgPerDay: 1500,
                minAgeMonths: 12,
                notes: ["Shake vigorously for 15 seconds each time before use", "Do not chew the microcapsules in the suspension"],
            },
            {
                id: "cipro-tab-250",
                label: "Tablet 250mg",
    ...
    prednisolone: {
        ...
        drugClass: "Corticosteroid",
        route: "PO",
        pediatricMgPerKgPerDay: 1, // Usually 1-2 mg/kg/day
        pediatricMgPerKgPerDose: 1, // Usually dosed once daily for asthma/croup
        adultDose: "40 mg",
        frequencyPerDay: 1,
        maxMgPerDay: 60,
        importantNotes: [
    ...
    dexamethasone: {
        ...
        drugClass: "Corticosteroid",
        route: "PO",
        pediatricMgPerKgPerDay: 0.6, // Typical for croup 0.6 mg/kg
        pediatricMgPerKgPerDose: 0.6, // Usually single dose or daily
        adultDose: "6 mg",
        frequencyPerDay: 1,
        maxMgPerDay: 16,
        importantNotes: [
